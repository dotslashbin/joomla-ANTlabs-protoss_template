		...
		<?php
			...
			<ul class="unstyled">
				<li>
					...
					<span class="icon-arrow-right"></span> <?php echo JText::_('MOD_LOGIN_REGISTER'); ?></a>
				</li>
				<li>
					<a href="<?php echo JRoute::_('index.php?option=com_users&view=remind'); ?>">
					  <span class="icon-arrow-right"></span> <?php echo JText::_('MOD_LOGIN_FORGOT_YOUR_USERNAME'); ?></a>
				</li>
				<li>
					<a href="<?php echo JRoute::_('index.php?option=com_users&view=reset'); ?>">
					<span class="icon-arrow-right"></span>  <?php echo JText::_('MOD_LOGIN_FORGOT_YOUR_PASSWORD'); ?></a>
				</li>
