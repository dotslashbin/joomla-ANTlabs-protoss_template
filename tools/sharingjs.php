...
// required for the tweets
$twitter_networking = $this->params->get('twitter_networking');
$tn = explode('/',$twitter_networking);
$twitteraccount = end($tn);
	 ...
	 $(document).ready(function() {
		<?php if( $this->params->get('twitter_share') == "1") { ?>
			$('#twitter-share').sharrre({
			  ...
			  trueHover: false,
			  <?php if ($ga != '' ) echo 'trueTracking: true,'; ?>
			  <?php if ($twitter_networking != '') echo 'buttons: { twitter: {via: "'.$twitteraccount.'"} },'; ?>
		...
		<?php if( $this->params->get('pinterest_share') == "1") { ?>
			$('#pinterest-share').sharrre({
			  ...
			  template: '<a class="box" href="#"><span class="social-icon social-icon-pinterest"></span><div class="count" href="#">{total}</div><div class="share"><span></span>Pinterest</div></a>',
			  trueHover: false,
			  <?php if ($ga != null ) echo 'trueTracking: true,'; ?>
			  urlCurl: '<?php echo $this->baseurl .'/templates/'. $this->template . '/tools/share.php'; ?>',
			  click: function(api, options){
				api.simulateClick();
		...
		<?php if( $this->params->get('stumbleupon_share') == "1") { ?>
			$('#stumbleupon-share').sharrre({
			  ...
			  template: '<a class="box" href="#"><span class="social-icon social-icon-stumble-upon"></span><div class="count" href="#">{total}</div><div class="share">StumbleUpon</div></a>',
			  trueHover: false,
			  <?php if ($ga != null ) echo 'trueTracking: true,'; ?>
			  urlCurl: '<?php echo $this->baseurl .'/templates/'. $this->template . '/tools/share.php'; ?>',
			  click: function(api, options){
		...
		<?php if( $this->params->get('delicious_share') == "1") { ?>
			$('#delicious-share').sharrre({
			  ...
			  template: '<a class="box" href="#"><span class="social-icon social-icon-delicious"></span><div class="count" href="#">{total}</div><div class="share">Delicious</div></a>',
			  trueHover: false,
			  <?php if ($ga != null ) echo 'trueTracking: true,'; ?>
			  urlCurl: '<?php echo $this->baseurl .'/templates/'. $this->template . '/tools/share.php'; ?>',
			  click: function(api, options){
